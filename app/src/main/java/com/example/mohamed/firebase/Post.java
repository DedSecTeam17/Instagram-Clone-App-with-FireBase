...
public class Post extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectImage = (ImageButton) findViewById(R.id.imagepost);
...
//            posting.child("name").setValue(mUser.getDisplayName());
                            ...
                            posting.child("username").setValue(dataSnapshot.child("username").getValue()).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Intent intent = new Intent(Post.this, Blog.class);
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(getBaseContext(), "Can not upload thos post", Toast.LENGTH_LONG).show();
                }
            });
...
//            selectImage.setImageURI(uri);
    ...
    private void askForPermission() {
        ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.CAMERA}, TAKE_IMAGE_PERMISSION);
    }

    private void check_for_permission() {
        int respone_permission = ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA);
